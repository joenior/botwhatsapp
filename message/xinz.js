...
//------------------< Math Random >-------------------
				...
				if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} aku jadi ganteng`)
					const bisa = ['Tentu saja bisa! Kamu adalah orang yang paling hoki. (Mungkin)', 'Duh, nggak bisa', 'Hmm... Nggak tau deh kalau itu', 'Coba ulang lagi.. Kurang paham saya']
				...
				if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} saya wibu`)
					const apa = ['Iya', 'Tidak', 'Bisa Jadi', 'Ulangi dong, nggak paham saya']
				...
				case prefix+'truth':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					const trut = ['Pernah suka sama siapa aja? berapa lama?', 'Kalau boleh atau kalau mau, di gc/luar gc siapa yang akan kamu jadikan sahabat?(boleh beda/sama jenis)', 'apa ketakutan terbesar kamu?', 'ernah suka sama orang dan merasa orang itu suka sama kamu juga?', 'Siapa nama mantan pacar teman mu yang pernah kamu sukai diam diam?', 'pernah gak nyuri uang nyokap atau bokap? Alesanya?', 'hal yang bikin seneng pas lu lagi sedih apa', 'pernah cinta bertepuk sebelah tangan? kalo pernah sama siapa? rasanya gimana brou?', 'pernah jadi selingkuhan orang?', 'hal yang paling ditakutin', 'siapa orang yang paling berpengaruh kepada kehidupanmu', 'hal membanggakan apa yang kamu dapatkan di tahun ini', 'Siapa orang yang sering kamu pikirin tiap hari?', 'siapa orang yang pernah buatmu sange', '(bgi yg muslim) pernah ga solat seharian?', 'Siapa yang paling mendekati tipe pasangan idealmu di sini', 'suka mabar(main bareng)sama siapa?', 'pernah nolak orang? alasannya kenapa?', 'Sebutkan kejadian yang bikin kamu sakit hati yang masih di inget', 'pencapaian yang udah didapet apa aja ditahun ini?', 'kebiasaan terburuk lo pas di sekolah apa?']
...
//------------------< Random >---------------------
				...
				break
				case prefix+'dorkjokes': case prefix+'darkjoke': case prefix+'jokes': case prefix+'dark':{
					if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				...
				break
				case prefix+'cewhor': case prefix+'ceritahoror':{
					if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
//------------------< INFO >-------------------
            ...
            case prefix+'sourcecode': case prefix+'sc': case prefix+'src':
                textImg(`https://github.com/Xinz-Team/XinzBot`)
                break
            case prefix+'runtime':
...
//------------------< nsfw >-------------------
            ...
            case prefix+'trapr':{
                ...
                reply(mess.wait)
                      ...
                      break
            case prefix+'nemko':
            case prefix+'blomwjob':
            case prefix+'kemyonomimi':
            case prefix+'kitrsune':
            case prefix+'yurmi':
            case prefix+'botobs':
            case prefix+'kufni':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
